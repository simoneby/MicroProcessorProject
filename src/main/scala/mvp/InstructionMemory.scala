...
class InstructionMemory() extends Module {
  ...
  switch(io.testSelect){
    ...
    is(4.U(3.W)){
      ...
      mem(0) := "b0000000000000010_0000_0010_001_0_0100".U  // 2 into reg2
      mem(1) := "b00000000_00000000_00000000_00000000".U
      mem(2) := "b00000000_00000000_00000000_00000000".U
      mem(4) := "b0000_00000011_0001_0000_0000000_1_0001".U // store reg1 at addr 3
      mem(5) := "b00000000_00000000_00000000_00000000".U
      mem(6) := "b00000000_00000000_00000000_00000000".U
      mem(7) := "b0000_00000001_0000_0010_0011_000_1_0000".U // load addr 3 (reg2 = 2 + offset 1) into reg3
    }
